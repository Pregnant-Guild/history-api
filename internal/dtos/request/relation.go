...
type GetRelationsDto struct {
	Type string   `json:"type" query:"type" validate:"required,oneof=wiki-entity entity-wiki geometry-entity entity-geometry entity-geometry-child entity-geometry-alone"`
	IDs  []string `json:"ids" query:"ids" validate:"required,min=1,dive,uuid"`
}
